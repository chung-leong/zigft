...
pub const animal_struct = extern struct {
    number1: i32 = @import("std").mem.zeroes(i32),
    number2: i32 = @import("std").mem.zeroes(i32),
};
pub const animal_ok: c_int = 0;
pub const animal_sick: c_int = 1;
pub const animal_dead: c_int = 2;
pub const animal_crazy: c_int = 3;
pub const animal_status = c_uint;
pub const animal_appearance_ugly: c_int = 0;
pub const animal_appearance_pretty: c_int = 1;
pub const animal_enum = c_uint;
pub const animal_cow = extern struct {
    number1: i32 = @import("std").mem.zeroes(i32),
    number2: i32 = @import("std").mem.zeroes(i32),
};
pub const animal_hen = extern struct {
    number1: i32 = @import("std").mem.zeroes(i32),
};
pub const animal_pig = extern struct {
    number1: i32 = @import("std").mem.zeroes(i32),
    number2: i32 = @import("std").mem.zeroes(i32),
    number3: i32 = @import("std").mem.zeroes(i32),
};
pub extern fn animal_mate(animal_cow, animal_hen) c_int;
pub extern fn animal_random(c_int, c_int, c_int) c_int;
pub extern fn animal_launch(pig: [*c]animal_pig) animal_status;
pub extern fn animal_smell(hen: [*c]const animal_hen) void;
pub fn animal_road_runner(arg_a: c_int, arg_b: c_int, arg_c: c_int) callconv(.c) c_int {
    var a = arg_a;
    _ = &a;
    var b = arg_b;
    _ = &b;
...
pub extern fn animal_pay_soccer_with(pig: animal_pig) align(64) c_int;
pub const struct_evil = extern struct {
    greed: c_int = @import("std").mem.zeroes(c_int),
    lust: c_int = @import("std").mem.zeroes(c_int),
    wrath: c_int = @import("std").mem.zeroes(c_int),
    gluttony: c_int = @import("std").mem.zeroes(c_int),
};
pub const animal_chicken = extern struct {
    eggs: c_int = @import("std").mem.zeroes(c_int),
    feathers: c_int = @import("std").mem.zeroes(c_int),
};
pub const struct_animal_kangaroo = extern struct {
    pocket: c_int align(64) = @import("std").mem.zeroes(c_int),
    punches: c_int = @import("std").mem.zeroes(c_int),
};
pub const animal_kangaroo = struct_animal_kangaroo;
pub const struct_animal_whale__ = opaque {};
pub const animal_whale_pointer = ?*struct_animal_whale__;
pub const animal_kangaroo_pointer = [*c]const animal_kangaroo;
pub const animal_duck = extern union {
    eggs: c_int,
    weight: f32,
};
pub const apple: c_int = 0;
pub const orange: c_int = 1;
pub const turkey: c_int = 2;
pub const animal_food = c_uint;
pub const anti_apple: c_int = -1;
pub const anti_orange: c_int = -2;
pub const anti_turkey: c_int = -65535;
pub const animal_anti_food = c_int;
...
// /home/cleong/.zvm/0.14.0/lib/include/__stddef_offsetof.h:16:9
...
// /home/cleong/.zvm/0.14.0/lib/include/stdint.h:291:9
pub const __intptr_t_defined = "";
pub const _INTPTR_T = "";
pub const _UINTPTR_T = "";
pub const __int_c_join = @compileError("unable to translate C expr: unexpected token '##'");
// /home/cleong/.zvm/0.14.0/lib/include/stdint.h:328:9
...
// /home/cleong/.zvm/0.14.0/lib/include/stdint.h:330:9
...
pub const evil = struct_evil;
pub const animal_whale__ = struct_animal_whale__;
